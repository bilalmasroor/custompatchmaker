      ...
      <Container>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="max-w-xl">
            <h2 className="text-[32px] font-semibold leading-[1.1] text-[#0b1c48] sm:text-[40px] lg:text-[48px]">
            ...
            <div className="mt-10 flex items-center gap-4">
              <a href="tel:+14372923019" aria-label="Urgent?" className="shrink-0 rounded-full bg-white p-3 shadow-sm">
                <PhoneIcon />
              </a>
              <div>
                <a href="tel:+14372923019" className="block text-[24px] font-bold leading-tight text-[#C91A25] hover:text-[#0B1C48] transition-colors">
                  Urgent?
                </a>
                <p className="mt-1 text-[15px] font-medium text-[#2B2B2B]">Call us +1 437 292 3019</p>
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-[#0B1C48]/10 bg-white p-8 shadow-[0_20px_40px_-15px_rgba(11,28,72,0.1)] sm:p-10">
            <h3 className="mb-6 text-[24px] font-bold text-[#0B1C48]">Get a Free Quote</h3>
